...
%  \twitter{@marissamayer}
%  \linkedin{linkedin.com/in/niccolò-salvini-datascience/}
   \github{github.com/NiccoloSalvini} % I'm just making this up though.
...
\cvevent{Università Cattolica del Sacro Cuore}{MSc Statistical and Actuarial Science | Data Business Analytics}{ Sep 2018 -- Dec 2020}{Milan, IT}
\begin{itemize}
\item GPA: 27.0/30.0\\
...
% Supervisor: PhD Luigi Della Vedova\\
% Ass. Supervisor: PhD Vincenzo Nardelli
\end{itemize}

\divider

\cvevent{Università Degli Studi di Firenze}{BSc Economia e Commercio}{ Sep 2013 -- Jul 2017}{Firenze, IT}
\begin{itemize}
\item GPA: 26.0/30.0\\
...
% Supervisor: Dott. Giampiero Maria Gallo
\end{itemize}

% \divider
\cvsection{Experience}
\cvevent{Board Member}{Data Network}{Sep 2019 -- Present}{Milan, IT}
\begin{itemize}
...
\cvevent{Accounting - Intern}{GHD}{Nov 2017 -- Mar 2018}{Firenze, IT}
\begin{itemize}
...
\cvevent{Delivery - Part time study job}{Sushi Aurora}{Sep 2014 -- Dic 2017}{Firenze, IT}
\begin{itemize}
...
\cvsection{Languages}
\cvskill{Italian}{5}
\cvskill{English (GMAT 580)}{5}
\cvskill{French (DEFL 99/100)}{3}
%\divider
